...
<div class="bg-gradient-to-br from-amber-50 to-amber-50 dark:from-amber-900/30 dark:to-amber-900/30 border-2 border-amber-300 dark:border-amber-700 rounded-2xl p-6 shadow-sm">
  <div class="flex-1">
    ...
    <!-- Test Mode Controls -->
    <div class="mt-4 p-4 bg-blue-100 dark:bg-blue-900/30 border-2 border-blue-200 dark:border-blue-700 rounded-2xl">
      <div class="flex items-start gap-4 mb-4">
        ...
        <div class="flex-1">
          <h4 class="font-bold text-blue-900 dark:text-blue-300 text-lg mb-1">
            C2PA Test Mode
          </h4>
    ...
    <div class="flex items-center justify-between gap-4 mt-4">
      <div>
        {#if testCertificates.length > 0}
          <span class="inline-flex items-center gap-2 px-4 py-1 bg-amber-200 dark:bg-amber-900/30 text-amber-900 dark:text-amber-300 rounded-full text-sm font-semibold">
      ...
      <button
        class="inline-flex items-center gap-2 px-6 py-2 bg-amber-700 hover:bg-amber-800 text-white rounded-lg transition-all duration-200 font-semibold text-sm whitespace-nowrap shadow-sm hover:shadow-lg transform"
      ...
      <div class="mt-4 space-y-2">
        {#each testCertificates as cert, index}
          ...
          <div class="bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm rounded-lg border {isTestRoot ? 'border-blue-400 dark:border-blue-700 ring-2 ring-blue-200 dark:ring-blue-700' : 'border-amber-200 dark:border-amber-700'} hover:bg-white dark:hover:bg-gray-800 transition-all overflow-hidden">
            <div class="flex items-center justify-between p-4 text-sm group">
              <button
                on:click={() => toggleExpand(index)}
                class="flex items-center gap-4 flex-1 text-left hover:opacity-80 transition-opacity"
              >
            ...
            {#if expandedCerts.has(index)}
              ...
              <div class="px-4 py-4 border-t border-amber-200 dark:border-amber-700 bg-white/50 dark:bg-gray-800/20">
                {#if certInfo}
