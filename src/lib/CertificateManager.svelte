    ...
    {#if testCertificates.length > 0}
      <div class="space-y-2">
        {#each testCertificates as cert, index}
          ...
          <div class="bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm rounded-lg border {isTestRoot ? 'border-blue-400 dark:border-blue-700 ring-2 ring-blue-200 dark:ring-blue-700' : 'border-gray-200 dark:border-gray-700'} hover:bg-white dark:hover:bg-gray-800 transition-all overflow-hidden">
            <div class="flex items-center justify-between p-4 text-sm group">
              ...
              >
                <div class="w-8 h-8 {isTestRoot ? 'bg-blue-100 dark:bg-blue-900/30' : 'bg-gray-100 dark:bg-gray-700'} rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            {#if expandedCerts.has(index)}
              ...
              <div class="px-4 py-4 border-t border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-gray-800/20">
                {#if certInfo}
